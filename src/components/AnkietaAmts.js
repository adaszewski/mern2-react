    ...
    <div>
      {props.amtsexam?  (
        <form onSubmit={handleSubmit(onSubmit)}>
          <h1>
            <strong>AMTS- Skrócony test sprawności umysłowej wg Hodgkinsona</strong>
          </h1>
          <br />
          <label>
          ...
          <label>
            <b>
              10. Proszę powtórzyć adres, który Pani /Pan miał(a) zapamiętać w
              trzecim pytaniu
            </b>
          </label>
          <br />
